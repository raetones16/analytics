 ...
 */
export async function readExcelFile(filePath: string, sheetName: string | number = 0) {
  try {
...
export async function getCustomerDataFiles() {
  try {
    ...
    console.error('Error getting customer data files:', error);
    return [];
  }
}
...
export async function getSalesDataFiles() {
  try {
    ...
    console.error('Error getting sales data files:', error);
    return [];
  }
}
...
export async function getSupportDataFiles() {
  try {
    ...
    console.error('Error getting support data files:', error);
    return [];
  }
}
